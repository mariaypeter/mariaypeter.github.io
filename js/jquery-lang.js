...
jquery_lang_js.prototype.runDynamically = function (parentSelector) {
	this.translate($(parentSelector + ' [lang]'));
}

jquery_lang_js.prototype.translate = function(langElems) {
